...
def predict():
    ...
    predictor = pickle.load(open(r"Models/model_rf_retrained.pkl", "rb"))
    scaler = pickle.load(open(r"Models/scaler_retrained.pkl", "rb"))
    cv = pickle.load(open(r"Models/countVectorizer_retrained.pkl", "rb"))
    try:
